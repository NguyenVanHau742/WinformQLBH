...
namespace QuanLyBanHang.Class
{
    public class Functions
    {
        ...
        public static void Connect()
        {
            ...
            conn.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\Project\Quản lý bán hàng\QuanLyBanHang\QuanLyBanHang\Quanlybanhang.mdf;Integrated Security=True;Connect Timeout=30";
            conn.Open();
